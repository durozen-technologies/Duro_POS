"""allow uncategorized inventory use movements

Revision ID: 0025_uncat_inventory_use
Revises: 0024_item_only_maps
...
revision: str = "0025_uncat_inventory_use"
down_revision: str | None = "0024_item_only_maps"
