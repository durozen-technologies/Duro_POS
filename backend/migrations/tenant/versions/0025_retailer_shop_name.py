"""Add retailer shop name text field."""
...
revision: str = "0025_retailer_shop_name"
down_revision: str | None = "0024_retailer_party_name_snapshots"
...
def upgrade() -> None:
    ...
    _add_retailer_column(bind, schema, "shop_name", sa.String(length=120))
...
def downgrade() -> None:
    ...
    if "shop_name" in columns:
        op.drop_column("retailers", "shop_name")
